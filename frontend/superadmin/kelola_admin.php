<?php
/**
 * Kelola Admin - Super Admin - Apotek Ananda Jadimulya
 */
...
?>
    ...
    <div class="page-header">
        <h1>Kelola Admin</h1>
        <p>Tambah, edit, dan hapus akun admin</p>
    </div>
    ...
    <div style="margin-bottom:15px;">
        <button class="btn btn-primary" onclick="openModal('modalTambahAdmin')">+ Tambah Admin</button>
    </div>
            ...
            <table>
                ...
                <tbody>
                    <?php if (empty($adminList)): ?>
                        <tr><td colspan="6" class="text-center" style="color:#94a3b8;padding:30px;">Belum ada akun admin</td></tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="<?= BASE_URL ?>/backend/controllers/admin_controller.php?action=delete" style="display:inline" onsubmit="return confirm('Hapus akun admin ini? Semua data terkait akan ikut terhapus.')">
                                    <?= csrfField() ?>
...
<div class="modal-overlay" id="modalTambahAdmin">
    <div class="modal">
        <div class="modal-header"><h3>Tambah Admin Baru</h3><button class="modal-close" onclick="closeModal('modalTambahAdmin')">&times;</button></div>
...
<div class="modal-overlay" id="modalEditAdmin">
    <div class="modal">
        <div class="modal-header"><h3>Edit Admin</h3><button class="modal-close" onclick="closeModal('modalEditAdmin')">&times;</button></div>
